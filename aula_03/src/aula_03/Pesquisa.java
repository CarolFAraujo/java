...
public class Pesquisa {
	...
	public static void main(String[] args) {
        ...
        while (continua == 'S') {
            ...
            System.out.println("Digite seu esporte favorito (1-Futebol/2-Voleibol/3-Games): ");
        ...
        System.out.println("Total de pessoas Trans e não binárias que" + " se identificam com o gênero F e gostam de games: " + gamesTNBF);
